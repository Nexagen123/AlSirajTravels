            ...
            <div className="relative w-full max-w-lg bg-white rounded-xl shadow-2xl p-6 sm:p-7 md:p-8 z-10">
              ...
              <form onSubmit={handleRequestReset} className="flex flex-col gap-4">
                <input
                  ...
                  type="email"
                  required
                  className="w-full px-4 py-3 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0758d8] focus:border-transparent text-gray-900 placeholder:text-gray-500"
                  placeholder="Email"
                  value={email}
                ...
                <button
                  ...
                  className={`w-full py-3 rounded text-base font-semibold mt-1
                    ${isLoading
                      ...
                      : "bg-(--siraj-blue-dark) text-white hover:bg-(--siraj-blue) shadow-md"}
