            ...
            <form onSubmit={handleChangePassword} className="flex flex-col gap-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#0758d8]"
              ...
              <button
                ...
                className={`w-full py-3 rounded-full text-lg font-semibold transition-all duration-300 
                  ${isLoading
                    ...
                    : "bg-(--siraj-blue-dark) text-white hover:bg-(--siraj-blue)"
                  }`}
              >
