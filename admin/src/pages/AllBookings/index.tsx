                            ...
                            <tr key={booking._id} className="border-b border-gray-300 hover:bg-blue-50/20 transition-colors">
                                ...
                                <td className="px-3 py-4 align-top text-center border-r border-gray-300">
                                    <div className="flex flex-col items-center gap-1">
                                        <span
                                            className={`inline-block px-2 py-1 rounded text-[10px] font-bold ${sourceBadge.className}`}
                                        >
                                            {sourceBadge.label}

                                            {booking.source === "fz-pakistan" && (
                                                <span
                                                    className={`ml-2 inline-block px-2 py-1 rounded text-[10px] font-semibold ${booking.fzPakistanBookingStatus === "success"
                                            ...
                                            {booking.source === "ammer-milat" && (
                                                <span
                                                    className={`ml-2 inline-block px-2 py-1 rounded text-[10px] font-semibold ${booking.ammerMilatBookingStatus === "success"
                                                        ? "bg-green-100 text-green-700"
                                        ...
                                        {(booking.status === "on hold" ||
                                            ...
                                            booking.status === "confirmed") && (
                                                <div className="flex flex-row justify-center items-center gap-2 w-full mt-2">
                                                    ...
                                                    <button
                                                        onClick={() => printGDSBooking(booking, { withPrice: true })}
                                                        className="px-2.5 py-2 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-all shadow-sm hover:shadow-md border border-emerald-200 cursor-pointer text-[10px] font-bold"
