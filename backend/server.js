...
import emmarRoutes from "./routes/emmar.routes.js";
import activityLogRoutes from "./routes/activitylog.routes.js";
import groupPricingRuleRoutes from "./routes/groupPricingRule.routes.js";
import packageVisibilityRoutes from "./routes/packageVisibility.routes.js";
import travelNetworkMarginRoutes from "./routes/travelNetworkMargin.routes.js";
import fzPakistanUmrahMarginRoutes from "./routes/fzPakistanUmrahMargin.routes.js";
import fullUmrahPackageMarginRoutes from "./routes/fullUmrahPackageMargin.routes.js";
import path from "path";
import { fileURLToPath } from "url";
import fzPakistanRoutes from "./routes/fzPakistan.routes.js";
...
app.use("/api/emmar", emmarRoutes);
app.use("/api/pricing-rules", groupPricingRuleRoutes);
app.use("/api/activity-logs", activityLogRoutes);
app.use("/api/package-visibility", packageVisibilityRoutes);
app.use("/api/travel-network-margin", travelNetworkMarginRoutes);
app.use("/api/fz-pakistan-umrah-margin", fzPakistanUmrahMarginRoutes);
...
(async () => {
  // Wait briefly for the DB connection to be established
